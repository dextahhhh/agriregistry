...
<html lang="en">
	<!--begin::Head-->
	<head>
		<title>AgRegistry | Individual</title>
		<meta charset="utf-8" />
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_app_body" data-kt-app-layout="light-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default" ng-app="individuals" ng-controller="individualsCtrl" account-profile>
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Individual Enrollment Form</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
							...
							<div class="mh-375px scroll-y me-n7 pe-7">
								...
								<div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="pictures/image.png" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-6">
		...
		<script src="modules/individuals.js?ver=1.0.0.0"></script>
		<script src="controllers/individuals.js?ver=1.0.0.0"></script>
	</body>
	<!--end::Body-->
</html>